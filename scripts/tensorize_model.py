...
def tensorize_model(
    ...
    logger.info(
        f"Tensorizing model {model_name} in {dtype} and writing tensors to {tensorizer_path}...")
    ...
    logger.info(
        f"Tensorized model {model_name} in {dtype} and wrote tensors to {tensorizer_path} and config to {config_path}...")
